...
![Version: 9.9.9](https://img.shields.io/badge/Version-9.9.9-informational?style=flat-square) ![AppVersion: 9.9.9](https://img.shields.io/badge/AppVersion-9.9.9-informational?style=flat-square)
...
| manager | object | `{"containerSecurityContext":{},"dnsConfig":{},"dnsPolicy":"","env":[],"envFrom":[],"image":{"pullPolicy":"IfNotPresent","registry":"ghcr.io","repository":"grafana/k6-operator","tag":"controller-v9.9.9"},"livenessProbe":{"httpGet":{"path":"/healthz","port":8081},"initialDelaySeconds":15,"periodSeconds":20},"logging":{"development":true},"podSecurityContext":{},"readinessProbe":{"httpGet":{"path":"/healthz","port":8081},"initialDelaySeconds":5,"periodSeconds":10},"replicas":1,"resources":{"limits":{"cpu":"100m","memory":"100Mi"},"requests":{"cpu":"100m","memory":"50Mi"}},"serviceAccount":{"create":true,"name":"k6-operator-controller"}}` | controller-manager configuration |
...
| manager.image | object | `{"pullPolicy":"IfNotPresent","registry":"ghcr.io","repository":"grafana/k6-operator","tag":"controller-v9.9.9"}` | controller-manager image configuration |
...
| manager.image.tag | string | `"controller-v9.9.9"` | controller-manager image tag |
